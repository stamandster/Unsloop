...
| BR-002 | Evaluate human voice through specificity, authorial presence, consistency, formulaicity, abstraction, redundancy, example function, emotional integrity, and logical progression across visible section boundaries and spoken thought chains. | Generic, manipulative, structurally abrupt, or orally disjointed prose improves without crude word bans, forced transitional language, or empty structural labels. |
...
| BR-026 | Support live, recorded, timed, interactive, media-assisted, and multi-format writing through delivery-aware budgets, audible reasoning continuity, evidence integration, audience design, optional-content decisions, and verified artifact synchronization. | A polished manuscript is not mistaken for a deliverable that fits its real duration, listener comprehension, audience, media, accessibility, or output-format constraints. |
...
| BR-030 | Treat websites and connected digital content as first-class writing artifacts across Review, Write, and Audit, with explicit coverage, reader-journey, claim, conversion, accessibility, search-presentation, technical-validation, and lifecycle boundaries. | Organizations and authors can improve web content without confusing a sampled content review with whole-site coverage, a content finding with technical or behavioral proof, or persuasive goals with permission to mislead. |
...
- Website and digital-content work across single pages, repeated page families, reader journeys, sections, sampled sites, and enumerated sites, including marketing, ecommerce, application microcopy, editorial, educational, public-information, documentation, help, policy, localization, migration, and authenticated content where access permits.
- Logical section-flow writing and review across chapters, headings, subheadings, scene breaks, procedural phases, and spoken paragraph-scale thought chains, including purposeful hard breaks.
- Delivery-aware speeches, presentations, narrated scripts, lessons, demonstrations, podcasts, and voiceovers with whole/section constraint reconciliation, audible reasoning, clear named-subject and pronoun reference, evidence framing, purposeful questions, audience layers, media decisions, closing movement, and format handoff.
