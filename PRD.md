...
| Review or audit website content | One page, page family, reader journey, scoped site, or captured corpus plus optional goals, sources, and analytics | Scope-bounded findings across purpose, structure, claims, voice, navigation, calls to action, search presentation, accessibility content, consistency, and lifecycle without silently changing the live site. |
| Write or revise website content | Site purpose, audience, page or content model, authoritative facts, brand evidence, action goal, and constraints | Page copy, navigation, microcopy, metadata, content plans, or migration mappings with supported claims, coherent journeys, and explicit implementation and validation boundaries. |
...
| PR-007 | Review specificity, authorial presence, consistency, redundancy, formulaicity, abstraction, example function, emotional integrity, useful irregularity, and logical flow across chapters, headings, subheadings, spoken paragraph-scale thought chains, or other material boundaries without classifying AI authorship or forcing artificial transitions. For spoken work, test whether questions, contrasts, consequences, or recurring key terms earn the next thought and whether named subjects and pronouns remain clear to listeners. | BR-002, BR-007 |
...
| PR-045 | For live, recorded, timed, interactive, or media-assisted writing, establish a delivery contract; reconcile the overall constraint with section allocations and all audience-time elements; preserve audible reasoning continuity through earned connections rather than structural labels alone; integrate evidence through need, orientation, presentation, interpretation, and use; review reference clarity, questions, audience layers, optional media, and closing movement proportionately; and recalculate timing after oral-flow revisions. | BR-003, BR-004, BR-005, BR-009, BR-012, BR-026 |
...
| PR-051 | When a website or connected digital surface is the artifact, route it through Review, Write, or Audit and distinguish that role from using a website as a research source. Bound the work to a single page, page family, reader journey, section, sampled site, or enumerated site; record inspected, rendered, inaccessible, dynamic, authenticated, localized, and generated states when material. | BR-003, BR-005, BR-006, BR-009, BR-022, BR-024, BR-030 |
| PR-052 | Evaluate or create website content proportionately across page purpose, audience movement, content hierarchy, claims and trust, voice and terminology, navigation and information scent, calls to action, search presentation, accessibility content, cross-page consistency, ownership, freshness, dependencies, migration, and maintenance. Keep content, technical, behavioral, legal, security, accessibility-conformance, search-ranking, and conversion conclusions within their actual evidence and specialist boundaries. | BR-001, BR-002, BR-003, BR-005, BR-007, BR-018, BR-022, BR-024, BR-030 |
...
| NFR-024 Web-scope integrity | Website conclusions remain reproducible and no broader than the captured or inspected corpus, applicable implementation checks, and behavioral evidence. | Output names the artifact role, live or captured version, acquisition method, page or journey coverage, inaccessible states, sample boundary, validation performed, and unresolved gaps; sampled results are never labeled whole-site findings. |
...
Given a website-content request, Unsloop first distinguishes the site as target artifact, evidence source, or both and establishes the smallest sufficient coverage: page, family, journey, section, sample, or enumerated site. It can serve corporate, service, product, campaign, ecommerce, SaaS, interface, editorial, educational, public-information, documentation, support, policy, multilingual, migration, and authenticated-content use cases without turning them into new modes. Findings identify the captured version, inspected and inaccessible states, page and cross-page strengths, evidence-linked problems, downstream effects, and actual validation. A content review does not imply a technical crawl, rendered accessibility conformance, legal or security review, search ranking analysis, conversion proof, or observed user testing unless the corresponding evidence and specialist capability were used.
