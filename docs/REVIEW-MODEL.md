...
For websites and connected digital content, first distinguish the site as target artifact, evidence source, or both. Bound the work to a page, page family, reader journey, section or subdomain, sampled site, or enumerated corpus and record inaccessible, dynamic, authenticated, localized, or generated states when material. Review the relevant layers: page purpose and hierarchy; claims and trust; voice and terminology; navigation and information scent; calls to action and interface language; search presentation; accessibility content; cross-page consistency; ownership, dependencies, freshness, and retirement. Keep inspected-content findings separate from tool-supported technical findings, actual behavioral evidence, and unverified hypotheses.
...
For spoken work, trace continuity within major sections as well as across headings: preceding thought, the relationship that makes the next thought necessary, and the next thought. Accept a question, contrast, consequence, or recurring key term when it genuinely carries the reasoning. Treat ordinal labels as optional orientation rather than proof of coherence. Check named subjects and pronouns for listeners who cannot reread, while preserving deliberate personal choices and purposeful pauses, direct turns, or hard breaks.

Integrate material evidence through its audience function: establish the need, orient the audience, present the evidence accurately, interpret what it establishes, and use it for the artifact's goal. This is a functional test, not a required five-sentence sequence. Give each material question a purpose, placement, answer path, expected pause or response, and payoff; do not impose a question quota. Give mixed audiences a shared entry point before optional depth. Treat consequential media choices as **Provisional—decision required** until accepted, and close with the movement appropriate to the genre rather than a generic recap or forced call to action. Recalculate timing after oral-flow revisions change questions, pauses, examples, or connective language.
