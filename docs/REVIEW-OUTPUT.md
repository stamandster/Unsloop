...
Give a short judgment of clarity, source integrity, writing consistency, specificity, and voice. State the evidence boundary when it affects confidence.

When an inferred or missing brief element materially shaped the review, add a compact **Brief assumptions** note. Do not recite settled fields or burden a simple review with an intake transcript.

### High-priority concerns

For each finding, include:

- **Passage:** a short excerpt or precise location
- **Problem:** the concrete issue
- **Why it matters:** effect on integrity, meaning, credibility, or voice
- **Evidence:** source comparison or textual pattern, when relevant
- **Severity:** Low, Moderate, High, or Critical
- **Suggested correction:** the smallest useful intervention
...
Name strong passages or habits worth preserving. Do not manufacture criticism to make the review appear comprehensive.

### Revised version

Include only when requested. If the user asks for both review and revision, keep the diagnosis distinct from the revised text.
...
List draft version, supplied sources, externally verified sources, inaccessible sources, and any similarity report used.

Record the writing goal and any consequential brief assumptions separately from the evidence corpus.

### Source map

| Draft location | Source | Relationship | Dependence score | Confidence |
|---|---|---|---:|---|
...
For website and digital-content work, return the requested page content, content plan, migration map, or prioritized findings first. Then state whether the site was target artifact, evidence source, or both; the live or captured version; page, family, journey, section, sample, or enumerated-site boundary; acquisition method; inspected and inaccessible states; strengths; page and cross-page effects; and validation performed. Label conclusions as Content finding, Technical finding, Behavioral finding, or Hypothesis. Sampled audits remain sample-bound, and Audit confirms that no live content was changed.

For delivered or presented work, return the requested artifact first. Then report only material delivery information: total and section constraints; the estimate or rehearsal basis; readings, pauses, questions, media, interactions, and transitions included in the time model; material spoken thought-chain or named-subject/pronoun findings; unresolved allocation conflicts; safety buffer; consequential audience, evidence-integration, media, interaction, or closing decisions; the authoritative content source; derivatives refreshed; validation actually performed; and the resulting readiness label. When oral-flow revision changes the delivery cost, report the revised estimate basis. Mark a derivative stale when the authoritative source changed but the derivative was not refreshed. Do not describe estimated timing as observed delivery, successful export as rendered or playable output, or unchecked derivatives as synchronized.
